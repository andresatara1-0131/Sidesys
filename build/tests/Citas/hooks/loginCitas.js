...
exports.loginCitas = loginCitas;
const helpers_1 = require("../../../utils/helpers"); // 🧩 Importar función de login
async function loginCitas(page) {
    await (0, helpers_1.loginToSuite)(page); // 🔐 Login a Suite
...
//# sourceMappingURL=loginCitas.js.map