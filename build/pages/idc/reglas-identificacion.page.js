...
exports.IDCReglasIdentificacionPage = void 0;
const idc_base_page_1 = require("./idc-base.page"); // 🏗️ Base de IDC
class IDCReglasIdentificacionPage extends idc_base_page_1.IDCBasePage {
    constructor(page) {
     ...
     * @param descripcion - Descripción de la regla
     */
    async crearNuevaRegla(descripcion) {
     ...
     */
    async editarRegla(rowIndex, nuevaDescripcion) {
     ...
     */
    async moverRegla(rowIndex, direction) {
     ...
     * @param descripcion - Descripción de la regla
     */
    async validarReglaExiste(descripcion) {
     ...
     * @param descripcion - Descripción de la regla
     */
    async validarReglaNoExiste(descripcion) {
        await this.searchInGrid(descripcion); // 🔍 Buscar regla
...
exports.IDCReglasIdentificacionPage = IDCReglasIdentificacionPage;
//# sourceMappingURL=reglas-identificacion.page.js.map