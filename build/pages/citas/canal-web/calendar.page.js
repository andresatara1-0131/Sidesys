...
exports.CitasCalendarPage = void 0;
const citas_base_page_1 = require("../citas-base.page"); // 🏗️ Base de Citas
class CitasCalendarPage extends citas_base_page_1.CitasBasePage {
    constructor(page) {
     ...
     */
    async expandAllSections(maxClicks = 5) {
     ...
     */
    async trySelectDayAndTime(dayNumber, preferredTimes) {
        try {
     ...
     */
    async selectAvailableDateAndTime(preferredTimes = ['12:30', '12:45', '13:15', '13:30', '13:45', '14:00']) {
        await this.waitForCalendar(); // ⏳ Esperar calendario
        const todayNumber = new Date().getDate(); // 📅 Obtener día actual
        const dayButtons = this.getEnabledDayButtons(); // 🔍 Días habilitados
        // 📊 Obtener números de días habilitados
        const dayNumbers = await dayButtons.evaluateAll((nodes) => nodes
            .map((n, i) => {
...
exports.CitasCalendarPage = CitasCalendarPage;
